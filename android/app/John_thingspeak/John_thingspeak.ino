...
const char* ssid = "achal15"; //write your ssid
const char* password = "achal123";//write your password

const char* host = "api.thingspeak.com"; // this is the server name

const char* THINGSPEAK_API_KEY = "LQHP965CFD39RIDP"; // //  Enter your Write API key from ThingSpeak
